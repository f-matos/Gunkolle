...
Gui, Add, DDL, x40 w60 ym-3 vWorldV,4_3E||5_4|5_4_friendly|5_2E|0_2|1_6|2_6|3_6|3_4N|4_6|5_6|6_6
...
FindOneAndClick(pics)
{
	Loop {
		Loop % pics.MaxIndex()
		{
			Found := 0
			Found := FindClick(A_ScriptDir pics[A_Index], "rNoxPlayer mc o30 Count1 n1 w500")
			if Found >= 1
			{
				return
			}
